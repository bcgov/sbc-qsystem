node('maven') {
    ...
    stage('code quality check') {
           ...
           dir('sonar-runner') {
            sh "./gradlew sonarqube -Dsonar.host.url=\"${SONARQUBE_URL}\" -Dsonar.verbose=true --stacktrace -Dsonar.java.binaries=.. -Dsonar.sources=.. -Dsonar.exclusions=../QSkyApi/web/resources/img/*"
           }
