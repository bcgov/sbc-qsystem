...
public class FReception extends javax.swing.JFrame {
    ...
    public FReception(IClientNetProperty netProperty) {
        ...
        tray = QTray.getInstance(fr, "/ru/apertum/qsystem/client/forms/resources/monitor.png",
            title()); //NOI18N
    ...
    private static String getLocaleMessage(String key) {
        if (localeMap == null) {
            localeMap = Application.getInstance(QSystem.class).getContext()
                .getResourceMap(FReception.class);
        }
    ...
    public static void main(String args[]) {
        ...
        builder = new FileBasedConfigurationBuilder<FileBasedConfiguration>(
            ...
            .configure(
                new FileBasedBuilderParametersImpl().setFileName("config/reception.properties")
                    .setEncoding("utf8"));
    ...
    private void init() {
        ...
        setTitle(
            getTitle() + " " + Uses
                .getLocaleMessage("project.name" + FAbout.getCMRC_SUFF())); //NOI18N

        try {
            setIconImage(ImageIO.read(FAdmin.class
                .getResource("/ru/apertum/qsystem/client/forms/resources/monitor.png"))); //NOI18N
        } catch (IOException ex) {
        ...
        for (String lng : Locales.getInstance().getAvailableLocales()) {
            final JRadioButtonMenuItem item = new JRadioButtonMenuItem(
                org.jdesktop.application.Application.getInstance(ru.apertum.qsystem.QSystem.class)
                    .getContext().getActionMap(FReception.class, this)
                    .get("setCurrentLang")); //NOI18N
            bg.add(item);
            ...
            public void mousePressed(MouseEvent e) {
                ...
                if (SwingUtilities.isLeftMouseButton(e)) {
                    ...
                    if (tablePreReg.getSelectedRow() >= 0 && service != null && service.isLeaf()) {
                        final FirstPreCell fc = (FirstPreCell) tablePreReg
                            .getValueAt(tablePreReg.getSelectedRow(), 0);
                        final GregorianCalendar gc = new GregorianCalendar();
                        gc.add(GregorianCalendar.HOUR_OF_DAY, 1);
                        if (fc.getAcust().getAdvanceTime() == null && fc.getDate()
                            .before(gc.getTime())) {
    ...
    private void userListChange() {
        if (listUsers.getLastVisibleIndex() != -1) {
            ...
            listServicesForUser
                .setModel(new DefaultComboBoxModel(user.getPlanServices().toArray()));
        }
    }
    ...
    private void showServiceInfo(QService service) {
        ...
        labelServiceInfo.setText("<html><body text=\"#336699\"> " + (service.getEnable() == 1 ? ""
            : "<font color=\"#FF0000\">!*** </font>") + s + " " + getLocaleMessage(
            "service.service")
            + service.getSeqId() + ": \"" + "<font color=\"#000000\">" + service.getName()
            + "\"    "
            + "</font>" //NOI18N
            + "<font color=\"#"
            ...
            .getPoint() //NOI18N
            + "</font>"
            + ";    " + getLocaleMessage("service.prefix") + ": " + "<font color=\"#DD0000\">"
            + service
            .getPrefix() + "</font>" + ";  " + getLocaleMessage("service.description") + ": "
            + service
            .getDescription() //NOI18N //NOI18N
...
// + getLocaleMessage("service.work_calendar") + ": " + "<font color=\"#" + (service.getCalendar() == null ? "DD0000\">" + getLocaleMessage("service.work_calendar.no") : "000000\">" + service.getCalendar().toString()) + "</font>" + ";  " + getLocaleMessage("service.work_calendar.plan") + ": " + "<font color=\"#" + (service.getSchedule() == null ? "DD0000\">" + getLocaleMessage("service.work_calendar.no") : "000000\">" + service.getSchedule().toString()) + "</font>" + ";<br>" //NOI18N
    ...
    private void initComponents() {
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application
            ...
            .getActionMap(FReception.class, this);
        ...
        textFieldSerchService
            .setText(resourceMap.getString("textFieldSerchService.text")); // NOI18N
        ...
        jPanel4Layout.setHorizontalGroup(
            jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jScrollPane2, javax.swing.GroupLayout.DEFAULT_SIZE, 1044,
                    Short.MAX_VALUE)
        );
        jPanel4Layout.setVerticalGroup(
            jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jScrollPane2, javax.swing.GroupLayout.DEFAULT_SIZE, 154,
                    Short.MAX_VALUE)
        );
        ...
        jPanel6Layout.setHorizontalGroup(
            jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jScrollPane7, javax.swing.GroupLayout.DEFAULT_SIZE, 1044,
                    Short.MAX_VALUE)
        );
        jPanel6Layout.setVerticalGroup(
            jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jScrollPane7, javax.swing.GroupLayout.DEFAULT_SIZE, 154,
                    Short.MAX_VALUE)
        );

        tabbedPaneService
            .addTab(resourceMap.getString("jPanel6.TabConstraints.tabTitle"), jPanel6); // NOI18N
        ...
        labelWarringOfLineSize
            .setText(resourceMap.getString("labelWarringOfLineSize.text")); // NOI18N
        labelWarringOfLineSize
            .setToolTipText(resourceMap.getString("labelWarringOfLineSize.toolTipText")); // NOI18N
        ...
        panelLineStateLayout.setHorizontalGroup(
            panelLineStateLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                    panelLineStateLayout.createSequentialGroup()
                        .addComponent(jScrollPane3, javax.swing.GroupLayout.DEFAULT_SIZE, 945,
                            Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(panelLineStateLayout
                            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(labelWarringOfLineSize,
                                javax.swing.GroupLayout.DEFAULT_SIZE,
            ...
            panelLineStateLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                    panelLineStateLayout.createSequentialGroup()
                        ...
                        .addContainerGap())
                .addComponent(jScrollPane3, javax.swing.GroupLayout.DEFAULT_SIZE, 154,
                    Short.MAX_VALUE)
        );

        tabbedPaneService.addTab(resourceMap.getString("panelLineState.TabConstraints.tabTitle"),
            panelLineState); // NOI18N
            ...
            panelServicesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(panelServicesLayout.createSequentialGroup()
                    .addComponent(jPanel7, javax.swing.GroupLayout.PREFERRED_SIZE,
                        ...
                        javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(jSplitPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 548,
                        Short.MAX_VALUE))
        );

        tabsPane.addTab(resourceMap.getString("panelServices.TabConstraints.tabTitle"),
            panelServices); // NOI18N
        ...
        listServicesForUser.setBorder(javax.swing.BorderFactory
            .createTitledBorder(
                resourceMap.getString("listServicesForUser.border.title"))); // NOI18N
            ...
            jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                    jPanel12Layout.createSequentialGroup()
                        .addComponent(labelUser)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jScrollPane9, javax.swing.GroupLayout.DEFAULT_SIZE, 307,
                            Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(buttonRefreshUser))
        );
        ...
        panelUsersLayout.setHorizontalGroup(
            panelUsersLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jSplitPane3, javax.swing.GroupLayout.DEFAULT_SIZE, 1051,
                    Short.MAX_VALUE)
        );
        ...
        tabsPane
            .addTab(resourceMap.getString("panelUsers.TabConstraints.tabTitle"),
                panelUsers); // NOI18N
        ...
        panelTreeCmbx.setBorder(javax.swing.BorderFactory
            .createTitledBorder(resourceMap.getString("panelTreeCmbx.border.title"))); // NOI18N
        ...
        checkBoxPrintAdvTicket
            .setText(resourceMap.getString("checkBoxPrintAdvTicket.text")); // NOI18N
        ...
        buttonRemoveAdvanceCustomer
            .setText(resourceMap.getString("buttonRemoveAdvanceCustomer.text")); // NOI18N
                ...
                .addGroup(panelPreregLayout.createSequentialGroup()
                    ...
                    .addGroup(
                        panelPreregLayout
                            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(panelPreregLayout.createSequentialGroup()
                                .addComponent(calPrereg, javax.swing.GroupLayout.PREFERRED_SIZE,
                                    250,
                                    javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        tabsPane.addTab(resourceMap.getString("panelPrereg.TabConstraints.tabTitle"),
            panelPrereg); // NOI18N
        ...
        buttonRefreshPostponed
            .setText(resourceMap.getString("buttonRefreshPostponed.text")); // NOI18N
            ...
            jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                    jPanel9Layout.createSequentialGroup()
                        .addComponent(jScrollPane4, javax.swing.GroupLayout.DEFAULT_SIZE, 938,
                            Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            ...
            jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                    jPanel9Layout.createSequentialGroup()
                        ...
                        .addComponent(buttonRefreshPostponed)
                        .addContainerGap())
                .addComponent(jScrollPane4, javax.swing.GroupLayout.DEFAULT_SIZE, 227,
                    Short.MAX_VALUE)
        );
            ...
            jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                    jPanel10Layout.createSequentialGroup()
                        .addComponent(jScrollPane5, javax.swing.GroupLayout.DEFAULT_SIZE, 938,
                            Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            ...
            jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                    jPanel10Layout.createSequentialGroup()
                        ...
                        .addComponent(buttonRefreshBlack)
                        .addContainerGap())
                .addComponent(jScrollPane5, javax.swing.GroupLayout.DEFAULT_SIZE, 318,
                    Short.MAX_VALUE)
        );
        ...
        labelTotalCustomers
            .setBackground(resourceMap.getColor("labelTotalCustomers.background")); // NOI18N
        ...
        jPanel2Layout.setHorizontalGroup(
            jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel2Layout.createSequentialGroup()
                    .addContainerGap()
                    .addComponent(labelTotalCustomers, javax.swing.GroupLayout.DEFAULT_SIZE,
                        javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addContainerGap())
        );
        ...
        jPanel3Layout.setHorizontalGroup(
            jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jScrollPane11, javax.swing.GroupLayout.DEFAULT_SIZE, 399,
                    Short.MAX_VALUE)
        );
        jPanel3Layout.setVerticalGroup(
            jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jScrollPane11, javax.swing.GroupLayout.DEFAULT_SIZE, 467,
                    Short.MAX_VALUE)
        );
        ...
        jPanel5Layout.setHorizontalGroup(
            jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jScrollPane12, javax.swing.GroupLayout.DEFAULT_SIZE, 645,
                    Short.MAX_VALUE)
        );
        jPanel5Layout.setVerticalGroup(
            jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jScrollPane12, javax.swing.GroupLayout.DEFAULT_SIZE, 467,
                    Short.MAX_VALUE)
        );
        ...
        buttonRefreshMainData
            .setText(resourceMap.getString("buttonRefreshMainData.text")); // NOI18N
        ...
        btnPushToTalk.setBorder(javax.swing.BorderFactory.createCompoundBorder(
            ...
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                    jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(btnPushToTalk, javax.swing.GroupLayout.PREFERRED_SIZE, 60,
                            javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap())
            ...
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel1Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel1Layout
                        .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(btnPushToTalk, javax.swing.GroupLayout.DEFAULT_SIZE, 57,
                            Short.MAX_VALUE)
                        .addComponent(buttonRefreshMainData, javax.swing.GroupLayout.DEFAULT_SIZE,
                            javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addContainerGap())
        );
        ...
        javax.swing.GroupLayout panelComplexServLayout = new javax.swing.GroupLayout(
            panelComplexServ);
        ...
        tabsPane.addTab(resourceMap.getString("panelComplexServ.TabConstraints.tabTitle"),
            panelComplexServ); // NOI18N
        ...
        menuItemChangePriority
            .setText(resourceMap.getString("menuItemChangePriority.text")); // NOI18N
    ...
    private void textFieldSerchServiceKeyReleased(
        java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textFieldSerchServiceKeyReleased
        TreeNode node = null;
    ...
    private void buttonRefreshPostponedActionPerformed(
        java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonRefreshPostponedActionPerformed
        QLog.l().logger().info(getLocaleMessage("request.to.server"));
        //элемент ответа.
        try {
            listPostponed.setModel(QPostponedList.getInstance()
                .loadPostponedList(NetCommander.getPostponedPoolInfo(netProperty)));
        } catch (Exception ex) {
    ...
    private void buttonRefreshBlackActionPerformed(
        java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonRefreshBlackActionPerformed
        listBlack
            .setModel(new DefaultComboBoxModel(NetCommander.getBanedList(netProperty).toArray()));
    }//GEN-LAST:event_buttonRefreshBlackActionPerformed

    private void buttonRefreshUserActionPerformed(
        java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonRefreshUserActionPerformed
        if (listUsers.getLastVisibleIndex() != -1) {
            final QUser user = (QUser) listUsers.getSelectedValue();
            if (user == null) {
                return;
            ...
            for (SelfService serv : plan.getSelfservices()) {
                ...
                tempAll =
                    tempAll + "<span style='color:" + (0 == count ? "green" : "red") + "'> - "
                        + serviceName
                        + ": " + count + people
            ...
            tempAll =
                "<span style='color:" + color + "'>" + allClients + inCount + "</span><br>"
                    + tempAll;
            ...
            if (plan.getCustomer() != null) {
                QLog.l().logger()
                    .trace("От сервера приехал кастомер, который обрабатывается юзером."); //NOI18N

                QLog.l().logger()
                    .trace("Установливаем кастомера работающему клиенту и выводем его."); //NOI18N
                ...
                if (min > standards.getWorkMax()) {
                    labelUserInfo.setIcon(new ImageIcon(
                        getClass().getResource(
                            "/ru/apertum/qsystem/client/forms/resources/attention.png"),
                        "")); //NOI18N
                ...
                tempAll =
                    tempAll + "<br>" + getLocaleMessage("working.with.client") + " " + textCust
                        + " " + min
                        + " " + getLocaleMessage("mints") + "<br><b><span style='color:#000000'> "
                        + getLocaleMessage("messages.service") + ": " + customer.getService()
                        .getName()
                        + "<br>" + getLocaleMessage("messages.priority") + ": " + priority + s
                        + "</span></b>";
                ...
                if (plan.getShadow() == null) {
                    labelUserInfo.setIcon(new ImageIcon(
                        getClass().getResource(
                            "/ru/apertum/qsystem/client/forms/resources/attention.png"),
                        "")); //NOI18N
                    tempAll = tempAll + "<br><span style='color:purple'>" + getLocaleMessage(
                        "not.working")
                        + "</span>";
                } else {
                    final int mnt = Math
                        .round(
                            (new Date().getTime() - plan.getShadow().getFinTime().getTime()) / 1000
                                / 60);
                    ...
                    tempAll =
                        tempAll + "<br><span style='color:" + (toolong ? "red" : "green") + "'>"
                            + getLocaleMessage("free3") + " " + mnt + getLocaleMessage("min.dot")
                            + "</span>";
                }
            }
    ...
    private void calPreregPropertyChange(
        java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_calPreregPropertyChange
        preRegChange(false);
    }//GEN-LAST:event_calPreregPropertyChange

    private void tablePreRegMouseClicked(
        java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablePreRegMouseClicked
        final QService service = (QService) comboBoxServices.getSelectedItem();
        if (((evt == null) || (SwingUtilities.isLeftMouseButton(evt) && evt.getClickCount() > 1))
            && tablePreReg.getSelectedRow() >= 0 && service != null && service.isLeaf()) {
            final FirstPreCell fc = (FirstPreCell) tablePreReg
                .getValueAt(tablePreReg.getSelectedRow(), 0);
            final GregorianCalendar gc = new GregorianCalendar();
            gc.add(GregorianCalendar.HOUR_OF_DAY, 1);
            ...
            if (fc.getAcust().getAdvanceTime() == null) {
                if (0 == JOptionPane
                    .showConfirmDialog(this, getLocaleMessage("make.pre.reg ") + fc + "?",
                    ...
                    String comments = (String) JOptionPane
                        .showInputDialog(this, getLocaleMessage("admin.comments"), "***", 3, null,
                            null,
                            ""); //NOI18N
                    if (inputData == null) {
                        inputData = ""; //NOI18N
                    ...
                    try {
                        res = NetCommander
                            .standInServiceAdvance(netProperty, service.getId(), fc.getDate(), -1,
                                inputData,
                                comments);
                    } catch (Exception ex) {
                        throw new ClientException(
                            getLocaleMessage("admin.send_cmd_adv.err") + " " + ex); //NOI18N
                    }
                    if (res == null) {
                        return;
                    }
                    ...
                    JOptionPane.showMessageDialog(this,
                        getLocaleMessage("admin.client_adv_dialog.msg_1") + " \"" + service
                            .getName() + "\". "
                            + getLocaleMessage("admin.client_adv_dialog.msg_2") + " \"" + res
                            .getId() + "\".",
                ...
                .showConfirmDialog(this, getLocaleMessage("clint.came") + fc + "?",
                    getLocaleMessage("pre.reg.2"), JOptionPane.YES_NO_OPTION)) {

                final RpcStandInService res = NetCommander
                    .standAndCheckAdvance(netProperty, fc.getAcust().getId());
                ...
                if (res != null) {
                    ...
                    if (res.getMethod()
                        ...
                        preRegChange(true);
                        JOptionPane.showMessageDialog(this,
                            getLocaleMessage("admin.client_adv_dialog.msg_3"),
                            getLocaleMessage("admin.client_adv_dialog.title"),
                            JOptionPane.INFORMATION_MESSAGE);
                    } else {
    ...
    private void checkBoxPrintAdvTicketItemStateChanged(
        java.awt.event.ItemEvent evt) {//GEN-FIRST:event_checkBoxPrintAdvTicketItemStateChanged
    ...
    private void listUsersOfServiceMouseClicked(
        java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listUsersOfServiceMouseClicked
        if (evt.getClickCount() > 1 && listUsersOfService.getSelectedIndex() != -1) {
            listUsers.setSelectedValue(
                listUsersOfService.getModel().getElementAt(listUsersOfService.getSelectedIndex()),
                true);
    ...
    private void listServicesForUserMouseClicked(
        java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listServicesForUserMouseClicked
        if (evt.getClickCount() > 1 && listServicesForUser.getSelectedIndex() != -1) {
            tabsPane.setSelectedComponent(panelServices);
            TreeNode[] nodes = ((DefaultTreeModel) treeServices.getModel()).getPathToRoot(
                ((ATreeModel) treeServices.getModel()).getById(
                    ((QPlanService) listServicesForUser.getSelectedValue()).getService().getId()));
            TreePath path = new TreePath(nodes);
            treeServices.setSelectionPath(path);
            treeServices.setExpandsSelectedPaths(true);
            treeServices.scrollPathToVisible(path);
    ...
    private void listUsersMouseClicked(
        java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listUsersMouseClicked
    ...
    private void tableServicesMonMouseClicked(
        java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableServicesMonMouseClicked
        if (evt.getClickCount() > 1 && tableServicesMon.getSelectedRow() != -1) {
            tabsPane.setSelectedComponent(panelServices);
            TreeNode[] nodes = ((DefaultTreeModel) treeServices.getModel()).getPathToRoot(
                ((ATreeModel) treeServices.getModel())
                    .getById(((ServiceInfo) tableServicesMon.getModel()
                        .getValueAt(tableServicesMon.getSelectedRow(), 2)).getId()));
            TreePath path = new TreePath(nodes);
            treeServices.setSelectionPath(path);
            treeServices.setExpandsSelectedPaths(true);
            treeServices.scrollPathToVisible(path);
    ...
    private void tableUsersMonMouseClicked(
        java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableUsersMonMouseClicked
        if (evt.getClickCount() > 1 && tableUsersMon.getSelectedRow() != -1) {
            listUsers
                .setSelectedValue(
                    tableUsersMon.getModel().getValueAt(tableUsersMon.getSelectedRow(), 0),
                    true);
            tabsPane.setSelectedComponent(panelUsers);
            buttonRefreshUserActionPerformed(null);
        }
    ...
    private void buttonRemoveAdvanceCustomerActionPerformed(
        java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonRemoveAdvanceCustomerActionPerformed
        if (tablePreReg.getSelectedRow() >= 0) {
            ...
            if (fc.getAcust().getAdvanceTime() == null) {
            ...
            } else if (0 == JOptionPane.showConfirmDialog(this,
                "Удалить предварительную запись " + fc.getAcust().getId() + " ко времени " + fc
                    + " безвозвратно?", getLocaleMessage("pre.reg.2"), JOptionPane.YES_NO_OPTION)) {

                final JsonRPC20OK res = NetCommander
                    .removeAdvancedCustomer(netProperty, fc.getAcust().getId());
                ...
                if (res != null) {
                    ...
                    if (res.getResult() == 1) {// костыль. тут приедет ID отказа
                        QLog.l().logger()
                            .info(
                                "Удалили предваоительного " + fc.getAcust().getId() + " на " + fc);

                        preRegChange(true);
                        JOptionPane.showMessageDialog(this,
                            getLocaleMessage("admin.client_adv_remove.msg_3"),
                            getLocaleMessage("admin.client_adv_dialog.title"),
                            JOptionPane.INFORMATION_MESSAGE);
                    } else {
                        JOptionPane.showMessageDialog(this,
                            "Не найдена предварительная запись по номеру " + fc.getAcust().getId(),
                            getLocaleMessage("admin.client_adv_dialog.title"),
                            JOptionPane.ERROR_MESSAGE);
                    }
                }
    ...
    private void miStandadvanceActionPerformed(
        java.awt.event.ActionEvent evt) {//GEN-FIRST:event_miStandadvanceActionPerformed
        tablePreRegMouseClicked(null);
    }//GEN-LAST:event_miStandadvanceActionPerformed

    private void miAdvanceToLineActionPerformed(
        java.awt.event.ActionEvent evt) {//GEN-FIRST:event_miAdvanceToLineActionPerformed
        tablePreRegMouseClicked(null);
    ...
    public boolean load() {
        ...
        panelComplexServ
            .add(new PComplexService((ATreeModel) (treeServices.getModel()), file, netProperty));

        final LinkedList<ServiceInfo> srvs;
        try {
            srvs = NetCommander.getServerState(netProperty);
            int amt = 0;
            amt = srvs.stream().map((serviceInfo) -> serviceInfo.getCountWait())
                .reduce(amt, Integer::sum);
            labelTotalCustomers.setText(
                "<html><span style='color:" + (amt > standards.getLineTotalMax() ? "red" : "green")
                    + "'>"
                    + getLocaleMessage("total.line") + " " + amt);
                ...
                public Component getTableCellRendererComponent(JTable table, Object value,
                    ...
                    final Component c = super
                        .getTableCellRendererComponent(table, value, isSelected, hasFocus, row,
                            column);
                    c.setBackground(
                        table.getSelectedRow() == row ? table.getSelectionBackground()
                            : Color.WHITE);
                    switch (column) {
                        case 0:
            ...
            QLog.l().logger()
                .error("Сервер ответил на запрос о состоянии: \"" + ex + "\""); //NOI18N
            tray.showMessageTray(getLocaleMessage("tray.server"),
                getLocaleMessage("tray.message.stop_server"), QTray.MessageType.WARNING); //NOI18N
            return false;
        }
        ...
        if (service != null && service.isLeaf()) {
            ...
            try {
                customer = NetCommander
                    .standInService(netProperty, service.getId(), "1", 1, inputData); //NOI18N
            } catch (Exception ex) {
        ...
        if (service != null && service.isLeaf()) {
            ...
            if (customers.getClients().size() > standards.getLineServiceMax()) {
                labelWarringOfLineSize.setIcon(new ImageIcon(
                    getClass()
                        .getResource("/ru/apertum/qsystem/client/forms/resources/attention.png"),
                    ""));
    ...
    public void checkAnyTicket() {
        ...
        if (num != null) {
            ...
            Uses.setLocation(f);
            RpcGetTicketHistory.TicketHistory t = NetCommander
                .checkCustomerNumber(netProperty, num);
            f.setInfo(t.getInfo());
    ...
    public void sendMessage() {
        FMessager.getMessager(this, netProperty.getClientPort(), listUsers.getModel(),
    ...
    private static class PreTableModel extends AbstractTableModel {
        ...
        public Object getValueAt(int rowIndex, int columnIndex) {
            ...
            final QAdvanceCustomer cust = time.getAcusts()
                .get(rowIndex % (greed.getAdvanceLimit()));
            switch (columnIndex) {
                case 0:
                ...
                case 1:
                    ...
                    return cust.getAdvanceTime() == null ? "<html><span style=\'color:" + clr
                        + "\'>"
                        + getLocaleMessage("Free") : cust.getId();
                case 2:
            ...
            switch (columnIndex) {
                ...
                case 1:
                    if (greed.get(rowIndex).getShadow() == null) {
                        return "<html><span style='color:purple'>" + getLocaleMessage("no.work")
                            + "</SPAN>";
                    } else if (greed.get(rowIndex).getShadow().getStartTime() == null) {
                        final int mnt = Math.round(
                            (new Date().getTime() - greed.get(rowIndex).getShadow().getFinTime()
                                .getTime())
                                / 1000 / 60);
                        final boolean toolong = (mnt > standards.getDowntimeMax());
                        return "<HTML><SPAN STYLE='COLOR:" + (toolong ? "RED" : "GREEN") + "'>"
                            + getLocaleMessage("Free2") + " " + mnt + getLocaleMessage("min.min")
                            + "</span>";
                    } else {
                        final int mnt = Math.round(
                            (new Date().getTime() - greed.get(rowIndex).getShadow().getStartTime()
                                .getTime())
                                / 1000 / 60);
                        final boolean toolong = (mnt > standards.getDowntimeMax());
                        return "<html><span style='color:" + (toolong ? "red" : "green") + "'>"
    ...
    private class QCustomer2 implements IidGetter {
        ...
        public String toString() {
            ...
            switch (customer.getPriority().get()) {
                ...
                case 2: {
                    priority =
                        "<span style='color:red'>[" + getLocaleMessage("messages.priority.hi")
                            + "]</span>"; //NOI18N
                    break;
                }
                case 3: {
                    priority =
                        "<span style='color:red'>[" + getLocaleMessage("messages.priority.vip")
                            + "]</span>"; //NOI18N
                    break;
                }
                default: {
                    priority =
                        "<span style='color:red'>[" + getLocaleMessage("messages.priority.strange")
                            + "]</span>"; //NOI18N
                }
            }

            final long min = ((new Date().getTime() - customer.getStandTime().getTime()) / 1000
                / 60);

            return "<html>" + nom + ".  " + customer.getPrefix() + customer.getNumber() + (
                customer.getPostponedStatus().isEmpty() ? "" : " " + customer.getPostponedStatus()
                    + (customer.getPostponPeriod() > 0 ? " (" + customer.getPostponPeriod()
                    + "min.)   "
                    : "  "))
                + (customer.getInput_data().isEmpty() ? "" : "  <u>" + customer.getInput_data())
                + "</u>    "
                + /*getLocaleMessage("messages.priority") + ": " +*/ priority + "  "
                + "<span style='color:" + (min <= standards.getWaitMax() ? "green" : "red") + "'>"
                + " - "
                + getLocaleMessage("waiting") + " " + min + " " + getLocaleMessage("mints2")
                + "</span>";
        }
