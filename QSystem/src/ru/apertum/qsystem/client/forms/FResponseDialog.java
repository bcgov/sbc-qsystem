    ...
    private static String getLocaleMessage(String key) {
        if (localeMap == null) {
            localeMap = Application.getInstance(QSystem.class).getContext()
                .getResourceMap(FResponseDialog.class);
        }
    ...
    private void showLevel(QRespItem level) {
        ...
        if (level.isLeaf() || level.getChildCount() == 1) {
            ...
            if (!root.getHTMLText().trim().isEmpty()) {
                final FResponseDialog.RespButton button = new FResponseDialog.RespButton(root,
            ...
            for (QRespItem item : level.getChildren()) {
                final FResponseDialog.RespButton button = new FResponseDialog.RespButton(item,
                    WelcomeParams.getInstance().buttonType);
                panelMain.add(button);
            }
            if (level != root) {
    ...
    private void initComponents() {
        ...
        panelUpLayout.setHorizontalGroup(
            panelUpLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(LabelCaption, javax.swing.GroupLayout.DEFAULT_SIZE, 1071,
                    Short.MAX_VALUE)
        );
        ...
        panelBottomLayout.setHorizontalGroup(
            panelBottomLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(panelBottomLayout.createSequentialGroup()
                    ...
                    .addComponent(buttonInRoot, javax.swing.GroupLayout.PREFERRED_SIZE, 252,
                        javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(18, 18, 18)
                    .addComponent(buttonBack, javax.swing.GroupLayout.PREFERRED_SIZE, 241,
                        javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addContainerGap())
        );
                    ...
                    .addGroup(
                        panelBottomLayout
                            ...
                            .addComponent(jButton2, javax.swing.GroupLayout.DEFAULT_SIZE, 78,
                                Short.MAX_VALUE)
                            .addComponent(buttonBack, javax.swing.GroupLayout.DEFAULT_SIZE,
                                javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(buttonInRoot, javax.swing.GroupLayout.DEFAULT_SIZE,
                                javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addContainerGap())
        );
                ...
                if (el.isLeaf()) {
                    ...
                    if (el.getInput_required()) {
                        inputData = FInputDialog
                            .showInputDialog(null, true, FWelcome.netProperty, false,
                                WelcomeParams.getInstance().delayBack, el.getInput_caption());
                    }
                    ...
                    if (item.isLeaf()) {
                        setIcon(new ImageIcon(
                            getClass().getResource(
                                "/ru/apertum/qsystem/client/forms/resources/feedback.png")));
                    } else {
                        setIcon(new ImageIcon(getClass()
                            .getResource(
                                "/ru/apertum/qsystem/client/forms/resources/feedback_group.png")));
                    }
                }
            }
        }
