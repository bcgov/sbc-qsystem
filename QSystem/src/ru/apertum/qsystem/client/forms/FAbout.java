...
public class FAbout extends javax.swing.JDialog {
        ...
        if (!"0".equals(CMRC_)) {
            JOptionPane
                .showMessageDialog(parent,
                    getLocaleMessage("about.version") + " : " + VERSION_ + "\n"
                        + getLocaleMessage("about.data") + " : " + DATE_
                        + "\n\nApertum Projects © 2009-2014",
        ...
        if (!"0".equals(CMRC_)) {
            JOptionPane
                .showMessageDialog(parent,
                    getLocaleMessage("about.version") + " : " + VERSION_ + "\n"
                        + ("".equals(verDB) ? ""
                        : (getLocaleMessage("about.db_version") + " : " + verDB))
                        + "\n" + getLocaleMessage("about.data") + " : " + DATE_
                        + "\n\nApertum Projects © 2009-2014",
                    Uses.getLocaleMessage("project.name" + FAbout.getCMRC_SUFF()),
                    JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void loadVersionSt() {
        ...
        final InputStream inStream = new String().getClass()
        ...
        CMRC_SUFF =
            "0".equals(CMRC_) || CMRC_.isEmpty() ? ""
                : (CMRC_.startsWith(".") ? CMRC_ : "." + CMRC_);
    }
    ...
    private void initComponents() {
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application
            ...
            .getActionMap(FAbout.class, this);
        ...
        jPanel3Layout.setHorizontalGroup(
            jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel3Layout.createSequentialGroup()
                    .addContainerGap()
                    .addComponent(jLabel2, javax.swing.GroupLayout.DEFAULT_SIZE, 477,
                        Short.MAX_VALUE)
                    .addContainerGap())
        );
                    ...
                    .addGroup(
                        jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jPanel5, javax.swing.GroupLayout.PREFERRED_SIZE,
                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(labelRight, javax.swing.GroupLayout.PREFERRED_SIZE, 13,
                                javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGap(30, 30, 30))
        ...
        getContentPane()
            .add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 500, 313));
        ...
        jTextArea1.setBorder(
            javax.swing.BorderFactory.createLineBorder(new java.awt.Color(-16777216, true), 4));
        ...
        getContentPane()
            .add(jScrollPane1,
                new org.netbeans.lib.awtextra.AbsoluteConstraints(-1, 311, 503, 295));
    ...
    private void jPanel1MouseClicked(
        java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel1MouseClicked

        setVisible(false);
    }//GEN-LAST:event_jPanel1MouseClicked

    private void jButton1KeyPressed(
        java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jButton1KeyPressed

        setVisible(false);
    }//GEN-LAST:event_jButton1KeyPressed

    private void labelRightMouseClicked(
        java.awt.event.MouseEvent evt) {//GEN-FIRST:event_labelRightMouseClicked
        try {
    ...
    private void jToggleButtonLicActionPerformed(
        java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButtonLicActionPerformed
