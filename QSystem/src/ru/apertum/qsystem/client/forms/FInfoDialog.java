...
public class FInfoDialog extends javax.swing.JDialog {
     ...
     */
    public static Long showInfoDialog(Frame parent, QInfoItem respList, boolean modal,
    ...
    private void showLevel(QInfoItem level) {
        ...
        buttonPrint.setVisible(
            (level.isLeaf() && level.getTextPrint() != null && !level.getTextPrint().isEmpty())
                || (level.getChildCount() == 1
                && level.getChildren().getFirst().getTextPrint() != null
                && !level.getChildren().getFirst().getTextPrint().isEmpty()));
        if (level.isLeaf() || level.getChildCount() == 1) {
            final JLabel label = new JLabel(Uses.prepareAbsolutPathForImg(
                level.isLeaf() ? level.getHTMLText()
                    : level.getChildren().getFirst().getHTMLText()));
    ...
    private void initComponents() {
        ...
        panelUpLayout.setHorizontalGroup(
            panelUpLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(LabelCaption2, javax.swing.GroupLayout.DEFAULT_SIZE, 1030,
                    Short.MAX_VALUE)
        );
        panelUpLayout.setVerticalGroup(
            panelUpLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(LabelCaption2, javax.swing.GroupLayout.DEFAULT_SIZE, 148,
                    Short.MAX_VALUE)
        );
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application
            .getInstance(ru.apertum.qsystem.QSystem.class).getContext()
            .getActionMap(FInfoDialog.class, this);
        ...
        buttonInRoot.setBorder(javax.swing.BorderFactory.createCompoundBorder(
            javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED),
            javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED)));
            ...
            panelBottomLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                    panelBottomLayout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(jButton2, javax.swing.GroupLayout.PREFERRED_SIZE, 215,
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(buttonBack, javax.swing.GroupLayout.PREFERRED_SIZE, 215,
                            javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap())
        );
                ...
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                    panelBottomLayout.createSequentialGroup()
                        ...
                        .addGroup(panelBottomLayout
                            ...
                            .addComponent(buttonBack, javax.swing.GroupLayout.DEFAULT_SIZE, 71,
                                Short.MAX_VALUE)
                            .addComponent(jButton2, javax.swing.GroupLayout.DEFAULT_SIZE, 71,
                                Short.MAX_VALUE)
                            .addComponent(buttonInRoot, javax.swing.GroupLayout.DEFAULT_SIZE, 71,
                                Short.MAX_VALUE)
                            .addComponent(buttonPrint, javax.swing.GroupLayout.DEFAULT_SIZE, 71,
                                Short.MAX_VALUE))
                        .addContainerGap())
        );
    ...
    private void buttonInRootActionPerformed(
        java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonInRootActionPerformed
        showLevel(root);
        if (infoDialog.clockBack.isActive()) {
            infoDialog.clockBack.stop();
        }
    ...
    private class InfoButton extends JButton {
        ...
        public InfoButton(final QInfoItem el, String resourceName) {
            ...
            addActionListener((ActionEvent e) -> {
                if (!el.isLeaf() || (el.isLeaf() && el.getTextPrint() != null && !""
                    .equals(el.getTextPrint()))) {
