...
public class FLogin extends javax.swing.JDialog {
    ...
    /**
     * The number of failed attempts, if 0 is infinite
     */
    ...
    /**
     * The current access level for the dialog
     */
    ...
    /**
     * Here we must clearly understand that either the userList is not NULL, or netProperty is not NULL
     *
     * @param userList
     * @param netProperty
     * @param parent
...
     * @return logged in user.
    ...
    public static QUser logining(INetProperty netProperty, JFrame owner, boolean modal, int count, int level) {
        QLog.l().logger().info("Login to the system."); // Вход в систему.
        if (loginForm == null) {
