...
public class FMoveToPostponed extends javax.swing.JDialog {
    ...
    public FMoveToPostponed(java.awt.Frame parent, boolean modal, Object[] results) {
        super(parent, modal);
        initComponents();
        comboBoxPeriod.setModel(
            new javax.swing.DefaultComboBoxModel(getLocaleMessage("conboBox.periods").split(",")));
    ...
    private static String getLocaleMessage(String key) {
        if (localeMap == null) {
            localeMap = Application.getInstance(QSystem.class).getContext()
                .getResourceMap(FMoveToPostponed.class);
        }
    ...
    private void initComponents() {
        ...
        comboBoxPeriod.setModel(new javax.swing.DefaultComboBoxModel(
            new String[]{"Бессрочно", "5 минут", "10 минут", "15 минут", "20 минут", "25 минут",
                "30 минут"}));
        ...
        jPanel1Layout.setVerticalGroup(
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel1Layout.createSequentialGroup()
                    ...
                    .addComponent(comboBoxResults, javax.swing.GroupLayout.PREFERRED_SIZE,
    ...
    private void comboBoxPeriodActionPerformed(
        java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboBoxPeriodActionPerformed
