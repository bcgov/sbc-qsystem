ALTER TABLE `clients`
ADD COLUMN `channels` BIGINT(20) NOT NULL DEFAULT '1';

ALTER TABLE `statistic`
ADD COLUMN `channels` BIGINT(20) NOT NULL;
...
BEGIN
    ...
    INSERT
        INTO statistic(state_in, results_id, user_id, client_id, service_id, user_start_time, user_finish_time, client_stand_time, user_work_period, client_wait_period, client_welcome_time, client_invite_time, service_quantity, channels)
    VALUES
        ...
        , NEW.welcome_time, New.invite_time, New.service_quantity, New.channels);
END$$
DELIMITER ;
