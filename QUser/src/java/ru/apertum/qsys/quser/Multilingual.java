...
public class Multilingual {
    ...
    public static final ArrayList<Lng> LANGS = new ArrayList<>(
        Arrays.asList(new Lng("Русский", "ru_RU"), ENG_LNG, new Lng("Español", "es_ES"),
            new Lng("Deutsch", "de_DE"), new Lng("Português", "pt_PT"),
            new Lng("Français", "fr_FR"),
            new Lng("Italiano", "it_IT"), new Lng("čeština", "cs_CZ"),
            new Lng("Polski", "pl_PL"),
            new Lng("Slovenčina", "sk_SK"), new Lng("Român", "ro_RO"), new Lng("Cрпски", "sr_SP"),
            new Lng("Український", "uk_UA"), new Lng("Türk", "tr_TR"),
            new Lng("हिंदी", "hi_IN"),
            new Lng("العربية", "ar_EG"), new Lng("עברית", "iw_IL"), new Lng("Қазақ", "kk_KZ"),
            new Lng("Indonesia", "in_ID"), new Lng("Suomi", "fi_FI")));
    ...
    public Lng init() {
        ...
        if (sess.getAttribute(org.zkoss.web.Attributes.PREFERRED_LOCALE) == null
            && Executions.getCurrent().getHeader("accept-language") != null && !Executions
            .getCurrent()
            .getHeader("accept-language").isEmpty()) {
            ln = Executions.getCurrent().getHeader("accept-language").split(";")[0]
                .replace("-", "_")
                .split(",")[0];
